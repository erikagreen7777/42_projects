...
function fill_table() {
	...
	$query = mysqli_query($conn, "SELECT * FROM stock ORDER BY id ASC");
...
<html>
	<head>
		...
		<title>SuperAdmin's Place</title>
	</head>
	<body>
		<header>
			<div class="header">
				<span class="header_name"> SuperAdmin's Place </span>
			</div>
			<a href="../index.php" id="exit"><button type="button">Exit</button></a>
		</header>
		<div class="main_view">
			<div class ="table">
				<?php fill_table() ?>
				...
				<div class = "button_wrapper">
					<a href = "../admin/edit_items.php" class = "buttons"> <button type="button">Edit items</button> </a>
					<a href = "../admin/edit_users.php" class = "buttons"> <button type="button">Edit users</button> </a>
