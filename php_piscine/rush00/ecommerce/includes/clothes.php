...
if (isset($_SESSION['wat'])) { echo '?'; } echo '
					...
					<button type="button">Sign Up</a></button>'; } else { echo "<h1>Welcome ". $_SESSION['who'] . "</h1>";}?>
		...
		<div id="content_area">
			<div class="row clearfix">
				<div class="col-1-3">
					...
					<br>
					<span class="nums">
						<form action="/includes/clothes.php" method="post">
							Quantity:
	<input type="number" name="count_jer"  min="1" max="100">
							<button type="submit" name="buy" value="ok" onclick="alert('Item added to cart')">Add to Cart</button>
